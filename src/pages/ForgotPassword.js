...
//	const history = useHistory()
	...
	const formSubmitter = e => {
		e.preventDefault();
		setsuccessMessage('');
		if (input.email=== "") return seterrorMessage("Please entre your Emial Id");
				...
				<div className="container-login100" style={{ backgroundImage: 'url("images/bg-01.jpg")' }}>
					<div className="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
						<form className="login100-form validate-form" onSubmit={formSubmitter}>
							<span className="login100-form-title p-b-49">Password Reset</span>
							...
							<div className="container-login100-form-btn">
								<div className="wrap-login100-form-btn">
									...
									<button className="login100-form-btn">Send Reset link</button>
								</div>
							</div>
